...
// ShutdownFunc is the type of the function invoked by Graceful to shut down the server
...
// When the signal is trapped, the shutdown handler will be invoked with a context that expires
